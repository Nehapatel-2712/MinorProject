<?php $s_email=$_SESSION['email'];
$s_en=$_SESSION['enrollmentno'];
...
$ins=mysql_query("INSERT INTO ans VALUES('','$postid','$s_name','$email','$apost')");
}
...
<div class="name">
           ...
           <div class="querymain">
            <?php
		  $query=mysql_query("select * from query where enrollmentno='$s_en' order by sno desc ");
