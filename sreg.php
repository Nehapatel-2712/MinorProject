         ...
         <div class="fdiv">
               <form action="sreg.php" method="post">
                                 <div class="heading">
                                      ...
                                      <input type="text2" placeholder="    Enrollment No."  name="enrollmentno" required=                                        "required" pattern="[0-9 A-Z a-z]{12}"/>
                                      <br/>
                                      ...
                                      <br/>
                                       ...
                                       <br/>
                                        ...
                                        <br/>
                                     <button type="button" onclick="sreg.php" value="submit" onblur="cpw()"><text>Submit<text></button>
                                     <br/>
